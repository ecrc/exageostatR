...
load(file="../..//data/90_10/XYZ_10K_15_0021080_15_1.rda")

data=list("x" = as.numeric(Datasets2$x), "y" = as.numeric(Datasets2$y),
	  "z" = as.numeric(Datasets2$Measure))                                       # Convert data for input
