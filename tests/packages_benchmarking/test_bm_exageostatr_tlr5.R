...
#
#
# @file test_bm_exageostatr_tlr5.R
...
exageostat_tlr5_modeling_predicting<-function(Data_train_list, Data_predict_list)  # Function of exageostat at tile low rank=5 modeling & predicting.
{
    dmetric = "euclidean"                                                          # 0 --> Euclidean distance, 1--> great circle distance.
    tlr_acc = 5                                                                    # Approximation accuracy 10^-(acc)
...
BM_out <- bm(FUN = exageostat_tlr5_modeling_predicting,  n = 8100,                 # Benchmarck Function BM used.
